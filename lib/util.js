...
function str_join(s, ...args)
{
  return args.filter((x) => { return !(typeof x == "string" && !x.length); })
      .map((x) => {
        if(typeof x == "object") return util.inspect(x, false, null, true);
