...
class ProfileManager {
    ...
    loadProfiles() {
        ...
        if(!this._curProfile)
            this._curProfile = this.profileDefault;
    }
    ...
    setCurrentProfile(profile) { this._curProfile = profile; }

    findLayer(name) {
        return this._curProfile._layers[name];
    }
    ...
    _validateKey(k) {
        if(!k || ValidKeyMap[k] || ValidMouseMap[k]) return k;
